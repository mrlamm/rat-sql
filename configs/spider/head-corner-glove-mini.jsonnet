local _base = import 'head-corner-base-mini.libsonnet';
...
function(args, data_path=_data_path) _base(output_from=true, data_path=data_path) + {
    ...
    model+: {
        ...
        encoder_preproc+: {
            ...
            save_path: _data_path + 'head-corner-glove,cv_link=%s' % args.cv_link,
        },
        decoder_preproc+: {
            grammar+: {
                end_with_from: true,
        ...
        decoder+: {
            ...
            grammar_path: _data_path + 'head-corner-glove,cv_link=%s' % args.cv_link,
        },
    },
